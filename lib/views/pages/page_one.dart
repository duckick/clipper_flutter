...
class _PageOneState extends State<PageOne> with SingleTickerProviderStateMixin, WidgetsBindingObserver{
        ...
        Container(
          ...
          child: GestureDetector(
              onTap: () {
                ...
                setState(() {
                  if (_trigger) {
                    player.play(AssetSource('audios/clipper.mp3'));
                  } else {
                    player.stop();
                  }
                  _trigger = !_trigger;
